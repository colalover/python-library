...
def run():
    ...
    ws = CoinFLEXWebsocket(endpoint="wss://api.coinflex.com/v1", base=Assets['XBTDEC'],counter=Assets['USDTDEC'], user_id=1901,
                         cookie='wBJEyQfkhjqAduUBblNB4GvctDc=', passphrase='Sy27091513')
