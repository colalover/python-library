...
class CoinFLEXWebsocket:
    ...
    def __on_message(self, ws, message):
        ...
        if not self.auth_complete:
            ...
            if message.get("notice", "") == "Welcome":
                self._process_welcome_message(message)
            elif "tag" in message and message["tag"] == self.auth_tag:
                self._process_authentication_response(message)
